    ...
    return(
        ...
        <div className='skillsContainer bg-white'>
            ...
            <div className="iconArea grid grid-cols-4 gap-12 mt-16">
                ...
                <dev className='flex justify-center align-middle'><FaReact className='text-7xl' title='React Js'/></dev>
                <dev className='flex justify-center align-middle'><FaVuejs className='text-7xl' title='Vue Js'/></dev>
                <dev className='flex justify-center align-middle'><SiRedux className='text-7xl' title='Redux'/></dev>
                <dev className='flex justify-center align-middle'><FaGit className='text-7xl' title='Git'/></dev>
                <dev className='flex justify-center align-middle'><FaGithub className='text-7xl' title='Github'/></dev>
